...
wandb.init(project="snow")

from src.utils import *
from src.dataset import MyDataset
from models.character_level_cnn import CharacterLevelCNN
...
def train(opt):
    ...
    for epoch in range(opt.num_epochs):
        for iter, batch in enumerate(training_generator):
            ...
            if opt.num_epochs % 10 == 0:
                wandb.log({"loss": loss, "accuracy":training_metrics["accuracy"]})
